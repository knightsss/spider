...
email = '1251314160@qq.com'
password = 'sfx19900918'
...
class douban_robot:
    ...
    def load_cookies(self):
        try:
            ...
            print "The cookies.txt file is not exist."
            self.login_douban()
            self.load_cookies()
    ...
    def login_douban(self):
        '''
        login douban and save the cookies.txt into file.
    ...
    def test_cookie_load(self):
        response = self.opener.open(test_url)
        print response.read()
...
#参考地址https://github.com/vi5i0n/doubanrobot/blame/master/douban.py
